...
class Population:
    ...
    def select_parents(self) -> None:  # Zmienia current gen na pule rodzicow do rozmnazania metoda progowa
        ...
        self.current_generation = self.current_generation[:(self.size*configuration.values["parent_group_size"]/100)]

    def select_best_specimen(self) -> Specimen:
        whole_population = self.current_generation
